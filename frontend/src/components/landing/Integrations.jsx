...
const paypalSVG = (
    <svg xmlSpace="preserve" viewBox="0 0 124 33" height="28px" style={{ width: "auto" }} xmlns="http://www.w3.org/2000/svg">
...
const logos = [
    {
        id: "stripe",
        content: (
            <svg viewBox="0 0 60 25" height="22" style={{ width: "auto" }} xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        id: "visa",
        content: (
            <svg viewBox="0 0 780 500" height="28" style={{ width: "auto" }} xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M146.92 152.96H62.919l-.682 3.996c65.164 15.814 108.24 54.006 126.13 99.88l-18.198-87.209c-3.144-12.099-12.297-15.33-23.253-16.667z" fill="#EB001B" />
            </svg>
        ),
    },
    {
    ...
    },
    {
        id: "amex",
        content: (
            <svg viewBox="0 0 750 471" height="28" style={{ width: "auto" }} xmlns="http://www.w3.org/2000/svg">
        ...
        >
            ...
            <div
                style={{
                    ...
                    overflow: "hidden",
                    position: "relative",
                    boxShadow: "0 0 0 1px rgba(255,255,255,0.03), 0 24px 64px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.05)",
                }}
            >
                {/* Left fade */}
                <div style={{
                ...
                >
                    {[...logos, ...logos].map((logo, i) => (
                        <LogoCard key={`${logo.id}-${i}`} content={logo.content} />
                    ))}
                </div>
            </div>
